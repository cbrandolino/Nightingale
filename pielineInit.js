...
$(function() {
	...
	new pieLine(data, $('#canvas2'),{
		...
		'click':function(elem){console.log('Holy shit you clicked the '+elem.slice.name+' slice');},
		'hover':function(elem){console.log('I\'ll be damned if it isn\'t the '+elem.slice.name+' slice you\'re hovering!');},});
